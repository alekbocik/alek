...
async function discord(){
    try{
        ...
        await page.screenshot({path: `ekwipunekdalek.png`, fullPage: true});
        const well = bot.channels.get("683374637819756623")
        await well.send({files: [`./ekwipunekdalek.png`]}).then(msg => (msg.delete(120000)));
        const path = `./ekwipunekdalek.png`
